...
2. The bolometric light curves of our models show a range of brightnesses, able to account for sub-luminous to normal brightness SNe Ia.<br>
3. on average, our brighter models lie within the observed data.<br>
4. the bolometric decline rate over 40 days, appears systematically faster than data.<br>
...
2. agreement between MCFOST-art and both TURBOspectrum and RH is excellent, of the order of 1% or below at most wavelengths.<br>
3. a few discrepancies are present, arising from the different treatment of opacities at a few critical wavelengths (e.g. at the Balmer jump or at the H􀀀 minimum).<br>
4. RH和MCFOST的流量差异达25% in the core of Ly$\alpha$, H$\alpha$和大部分other wavelengths in the spectrum的差异低至1%.
